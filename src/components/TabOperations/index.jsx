    ...
    return (
        <section className="list_transac">
            ...
            list.map((item,idx)=>{
                ...
                return (
                    <div className="content_transac tab-color" key={idx}>
                        ...
                        <div className="content_transac_col-x2" tab-color>{item.TransAmount}</div>
                        ...
                        <div className={cl}>
                            ...
                            <div className="content_transac_col-x2 cel-align-left" tab-color>Transaction type</div>
                            <div className="content_transac_col-x4 cel-align-left">{item.TransType.name}</div>
                            <div className="content_transac_col-x6"></div>
                            <div className="content_transac_col-x2 cel-align-left" tab-color>Category</div>
                            ...
                            <div className="content_transac_col-x2 cel-align-left" tab-color>Note</div>
